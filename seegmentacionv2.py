...
img_erosion = cv2.erode(closing, kernel, iterations=2)
...
imgconv = cv2.cvtColor(closing, cv2.COLOR_HSV2BGR)
...
cv2.imshow("Ventanawwaaw",imgfull)
cv2.imshow("fueque",imgconvGray)
